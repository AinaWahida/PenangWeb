            ...
            <div className="Part-2">
                ...
                <div className="description-container">
                    <p>
                        ...
                        <br/><br/>The price for Mee Goreng Sotong starting from RM8.50 per plate. Plase note  that prices may vary based on portion sizes and any additional ingredients. For the most accurate and up-to-date pricing, it's advisable to contact the stall directly or visit in person.
                    </p>
                </div>
            </div>
