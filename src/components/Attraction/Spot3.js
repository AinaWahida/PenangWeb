    ...
    return (
        <div className="tourist-section">
            ...
            <div className="part2">
                <div className="collage">
                    <div className="left">
                        <img src={require('./images-attraction/spot3.6.jpg')} alt="img5" onClick={() => openModal(require('./images-attraction/spot3.6.jpg'))}/>
                        <img src={require('./images-attraction/spot3.5.webp')} alt="img6" onClick={() => openModal(require('./images-attraction/spot3.5.webp'))}/>
                    </div>
                    <div className="left">
                        <img src={require('./images-attraction/spot3.7.jpg')} alt="img7" onClick={() => openModal(require('./images-attraction/spot3.7.jpg'))}/>
                        <img src={require('./images-attraction/spot3.8.webp')} alt="img8" onClick={() => openModal(require('./images-attraction/spot3.8.webp'))}/>
                    </div>
                </div>
                <p>
                    ESCAPE Penang is part of the ESCAPE theme park series, known for its emphasis on outdoor fun and promoting an active, healthy lifestyle.
                    The park is designed with sustainability in mind, with a commitment to minimizing its environmental impact while offering an eco-friendly experience.
                    The attractions are inspired by the region's natural landscapes, allowing visitors to immerse themselves in the beauty of the forest while engaging in exciting challenges.
                    Whether you're looking for an adrenaline rush or a fun day out with family and friends, ESCAPE Penang offers an unforgettable experience.
                    With its combination of adventure, nature, and innovation, ESCAPE Penang is fast becoming one of the island's top destinations for those seeking an outdoor thrill.
                </p>
            </div>
            <div className="part3">
                <iframe
