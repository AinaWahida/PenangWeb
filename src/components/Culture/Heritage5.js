            ...
            <div className="Part1">
                ...
                <div className="description-container">
                    <p>
                        ...
                        With its stunning Moghul architecture, including intricate minarets and domes, it is a must-visit destination. To enter the mosque, visitors should dress appropriately, as improper attire may result in denied entry.
            ...
            <div className="Part2">
                <div className="description-container">
                    <p>
                        ...
                        The mosque’s serene atmosphere is complemented by its well-maintained gardens and fountains, providing a peaceful retreat for visitors. For those interested in delving deeper into its history and significance, guided tours are available, offering insights into Islamic practices and the mosque’s role in fostering community harmony.
                        Proper attire is essential for entry, and visitors are encouraged to plan their visits around the five daily Muslim prayers.
                        The Kapitan Keling Mosque not only serves as a place of worship but also as a popular photographic subject, celebrated for its architectural beauty and cultural importance.
                    </p>
                </div>
